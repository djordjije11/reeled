...
import io.github.djordjije11.reeled.postmetrics.domain.PostDailyPerformance;
import io.github.djordjije11.reeled.postmetrics.domain.PostDailyPerformanceKey;
import io.github.djordjije11.reeled.postmetrics.domain.PostDailyPerformanceRepository;
...
public class PostDailyPerformanceService {
    ...
    private void save(PostDailyPerformanceKey key, Long searchAppearances, Long views) {
        ...
        postDailyPerformanceRepository.findByKey(key).ifPresentOrElse(postDailyPerformance -> {
            postDailyPerformance.update(searchAppearances, views);

            postDailyPerformanceRepository.save(postDailyPerformance);
        }, () -> postDailyPerformanceRepository.save(new PostDailyPerformance(key, searchAppearances, views)));
