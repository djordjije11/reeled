...
A java library containing standard codes (enumerated values) from different services and modules.
...
dependencies {
    ...
    implementation 'io.github.djordjije11.reeled:reeled-codes:<version>'
}
```
